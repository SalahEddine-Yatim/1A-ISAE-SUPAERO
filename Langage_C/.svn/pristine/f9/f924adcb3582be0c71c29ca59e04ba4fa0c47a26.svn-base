...
minmax_list *singleton_list() {
    ...
    p_list->linked_list->p_next = NULL;
...
minmax_list *simple_list() {
    ...
    p_list->linked_list         = malloc(sizeof(cell_int));
    p_list->linked_list->value  = -1;
    p_list->linked_list->p_next = malloc(sizeof(cell_int));

    p_list->linked_list->p_next->value  = 2;
    p_list->linked_list->p_next->p_next = malloc(sizeof(cell_int));

    p_list->linked_list->p_next->p_next->value  = 4;
    p_list->linked_list->p_next->p_next->p_next = NULL;
